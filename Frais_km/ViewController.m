...
- (void)viewDidLoad {
    ...
    _bienvenue.text = [NSString stringWithFormat:@"Connecté en tant que %@", _identifiant];
    ...
    @try {
        if (sqlite3_open(dbpath, &_DB) == SQLITE_OK)
        {
            ...
            NSData *jsonDataVersion = [NSData dataWithContentsOfURL:
                                       [NSURL URLWithString:@"http://localhost:8888/frais_km/service_nouveautarif.php"]];
            ...
            else
            {
                ...
                NSData *jsonDataTarif = [NSData dataWithContentsOfURL:
                                         [NSURL URLWithString:@"http://localhost:8888/frais_km/service_tarifs.php"]];
                ...
                NSData *jsonDataCarbu = [NSData dataWithContentsOfURL:
                                         [NSURL URLWithString:@"http://localhost:8888/frais_km/service_carburant.php"]];
                ...
                for (NSDictionary *dataDict in jsonObjectCarbu) {
                    ...
                    NSLog(@"%@",[dictcarbu objectForKey:@"LIBELLE"]);
                }
                ...
                for (i = 0; i < idtabcarbu.count; i++)
                {
                    ...
                    NSLog(@"INSERT INTO CARBURANT (ID, LIBELLE) VALUES (%@, '%@')", idtabcarbu[i],libtabcarbu[i]);
                ...
                for (NSDictionary *dataDict in jsonObjectPui) {
                    ...
                    dictcarbu = [NSDictionary dictionaryWithObjectsAndKeys:
                                 ...
                                 nil];
                    [idtabcarbu addObject:[dictpui objectForKey:@"ID"]];
                    [libtabcarbu addObject:[dictpui objectForKey:@"LIBELLE"]];
                    
                }
                
                
                
                NSString *truncatepui = [NSString stringWithFormat:@"DELETE FROM CARBURANT"];
                ...
                {
                    NSString *insertpui = [NSString stringWithFormat:@"INSERT INTO CARBURANT (ID, LIBELLE) VALUES (%@, '%@')", idtabpui[i],idtabpui[i]];
                    const char *pui_stmt = [insertpui UTF8String];
...
- (IBAction)soumission:(id)sender {
    ...
    NSDate *date = [formatter dateFromString:dateToday];
    ...
    else if (_securite == true)
    {
        ...
        UIAlertAction* yesButton = [UIAlertAction
                                    ...
                                    handler:^(UIAlertAction * action)
                                    {
                                        ...
                                        NSString *urlString = [NSString stringWithFormat:@"http://localhost:8888/frais_km/service_soumission.php?idvisiteur=%@&idprix=%@&km=%@&total=%.2f", _identifiant, idprix, _km.text, _number*[_km.text floatValue]];
